 ...
 * Slug: suede/pricing-2-columns
 * Categories: suede-pricing
 */
?>
...
<div class="wp-block-group alignfull" style="margin-top:0;padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)">
	...
	<div class="wp-block-group">
		...
		<h2 class="wp-block-heading has-text-align-center has-xxx-large-font-size"><?php echo esc_html__( 'Two tiers.', 'suede' ); ?><br><?php echo esc_html__( 'Zero compromises.', 'suede' ); ?></h2>
		<!-- /wp:heading -->
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group has-border-color has-black-border-color" style="border-width:1px;padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--60)">
				...
				<div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--40)">
					<!-- wp:button {"style":{"dimensions":{"width":"var:preset|dimension|100"}}} -->
					<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="#"><?php echo esc_html__( 'Get Basic →', 'suede' ); ?></a></div>
					<!-- /wp:button -->
				</div>
				<!-- /wp:buttons -->
			</div>
